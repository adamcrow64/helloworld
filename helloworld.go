...
func (s *helloworld) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	s.r.ServeHTTP(w, r)
}

func (s *helloworld) Close() error {
	s.Lock()
	defer s.Unlock()
...
func (s *helloworld) listBackends(w http.ResponseWriter, r *http.Request) {
...
func (s *helloworld) getBackend(w http.ResponseWriter, r *http.Request) {
	id := mux.Vars(r)["id"]
...
func (s *helloworld) addBackend(w http.ResponseWriter, r *http.Request) {
	var (
...
func (s *helloworld) deleteBackend(w http.ResponseWriter, r *http.Request) {
	id := mux.Vars(r)["id"]
...
func (s *helloworld) marshal(w http.ResponseWriter, v interface{}) {
